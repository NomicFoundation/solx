...
pub(crate) struct SelectorComputer;
...
impl SelectorComputer {
    ...
    /// # Panics
    ///
    /// Panics if the keccak256 hash produces fewer than 4 bytes, which is
    /// unreachable because keccak256 always produces 32 bytes.
