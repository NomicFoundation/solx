//!
//! The function scope: the enclosing contract scope, whether the frame is a constructor's, the
...
pub struct FunctionScope<'contract, 'source_unit, 'context> {
    ...
    /// Whether the frame is a constructor's, own or base, where an immutable is read through its
    /// creation cell rather than loaded from the linked code.
...
impl<'contract, 'source_unit, 'context> FunctionScope<'contract, 'source_unit, 'context> {
    ...
    /// Binds each named parameter to a stack slot holding its value.
