...
/// Emits a multi-valued expression to all its values: a tuple yields its elements, a call its
/// results. Used where several values are consumed at once: a tuple return or a destructuring
/// declaration.
