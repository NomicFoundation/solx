...
contract C {
    ...
    function unchecked_mod(uint256 a, uint256 b) public pure returns (uint256) {
        unchecked { return a % b; }
    }
    ...
    function unary_neg_checked(int256 a) public pure returns (int256) {
        return -a;
    }
    ...
    function signed_sub(int256 a, int256 b) public pure returns (int256) {
        return a - b;
    }

    function signed_mul(int256 a, int256 b) public pure returns (int256) {
        return a * b;
    }
    ...
    function signed_mod(int256 a, int256 b) public pure returns (int256) {
        return a % b;
    }
