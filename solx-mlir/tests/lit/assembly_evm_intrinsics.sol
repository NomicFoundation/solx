...
// Inline-assembly EVM intrinsics that solx now lowers to their `yul` dialect ops,
// matching solc. Functions emit in an unspecified order, so match order-independently.
// CHECK-DAG: yul.msize
