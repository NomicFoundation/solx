...
⚪ **No output data** — no size or gated-gas comparison had a `main-solc` counterpart to compare against.
...
⚠️ **No baseline** — Hardhat: 1 run (5 failures) has no `main-solc` counterpart; its failures are not compared.
