...
impl TargetMachine {
    ...
    ///
    /// The spill region is described by the "evm-memory-guard" and
    /// "evm-stack-region-size" module flags, not on the command line.
    ///
    ...
    pub fn new(
        ...
        let mut arguments = Vec::with_capacity(2 + llvm_options.len());
